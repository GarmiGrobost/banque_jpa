...
public class BanqueRepository {
	...
	public static void main(String[] args) {
		...
		BanqueRepository.insertEntities();
	}
	...
	private static void insertEntities() {
		...
		final var operation3 = new Operation(LocalDateTime.of(2022, 05, 1, 20, 30), "dépôt", 200D, compte1);
...
//	        compte1.setOperations(Arrays.asList(virement1));
		...
		// SI les interaction avec la base de donnee sont valides, les appliquent, et
